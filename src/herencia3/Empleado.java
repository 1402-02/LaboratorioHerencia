...
String codigo ;
codigo = JOptionPane.showInputDialog("Ingrese el código del empleado: ");
...
peso = Double.parseDouble(JOptionPane.showInputDialog("Ingrese el peso del empleado: "));

//Obtenemos los datos que no hacen parte de la clase
numeroHoras = Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número de horas trabajadas por el empleado: "));
valorHora = Double.parseDouble(JOptionPane.showInputDialog("Ingrese el valor de la hora: "));
esEmpleadoFijo = Boolean.parseBoolean(JOptionPane.showInputDialog("¿El empleado es fijo (true/false)?: "));
