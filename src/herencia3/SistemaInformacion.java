...
* por cada clase
*/
public class SistemaInformacion extends Persona
{
/********************************/
/********************************/
/********************************/
...
opcion = sistemaInformacion.leerDatoTipoEntero("Ingrese el numero 1 para procesar los datos del empleado: "
        + "\nEl numero 5 para los datos del estudiante: "
        + "\nEl numero 3 para salir");
if (opcion == 1)
{
...
if (opcion == 5) {
Estudiante gato4 = new Estudiante(opcion, peso, edad, nombre, apellido, edad, peso);
gato4.promedio();
}
if (opcion == 3)
{
...
} while (opcion <= 1 || opcion >= 5);//fin del do-while
